        ...
        <tbody>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td align="center" style="padding: 14px; border-radius: 4px; background-color: rgb(6, 182, 212);">
                                    <a href="${consumer_uri}/reset-password/${code}" target="_blank" style="font-family: Segoe UI; text-decoration: none; font-size: 20px; line-height: 16px; color: white; border-radius: 4px; overflow: visible; font-weight:bold; ">Reset Password</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <th style="padding-top: 35px;">
                    <span style="padding-top: 15px; text-align: center; font-family: Segoe UI; font-size: 15px; color: rgb(6, 182, 212); font-weight: lighter;">Button not working? Paste this link into your browser instead: <br/>${consumer_uri}/reset-password/${code}</span>
                </th>
            </tr>
            <tr>
